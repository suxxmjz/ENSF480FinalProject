...
//		   results.close();
   ...
   public Ticket getTicket(int id, String email) {
	   ...
	   try {
		   ...
		   if(results.next()) {
				   ...
				   returnObj = new Ticket(id, seat,  showroom_ID,  movie,  temp,  showingTime, email, price);
			   }
		   stmt.close();
		   results.close();
	   } catch(Exception e) {
   ...
   public void addTicket(Ticket t) {
	   ...
	   try {
		   ...
		   stmt.setString(3, t.getShowroomID());
		   stmt.setString(4, t.getMovieName());
		   stmt.setTimestamp(5, Timestamp.valueOf(t.getDatePurchased().atStartOfDay()));
		   stmt.setTimestamp(6, Timestamp.valueOf(t.getShowingTime()));
   ...
   public boolean validateVoucher(Voucher V) {
